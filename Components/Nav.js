    ...
    <aside className="bg-blue-900 pl-0 md:pl-4 pt-1 md:pt-4 p-4 pr-0 h-8 md:h-full md:static fixed flex md:flex-col bottom-0 md:top-0 w-screen md:w-auto md:justify-start justify-center">
      ...
      <div className="flex md:flex-col md:gap-3  text-xs md:text-base justify-around w-screen md:w-auto  ">
        <Link href={"/"}>
          <div className={path === "/" ? active : inactive}>
            <svg
              ...
              strokeWidth="1.5"
              stroke="currentColor"
              className={path === "/" ? iconActive : iconInactive}
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
        ...
        <Link href={"/categories"}>
          <div className={path === "/categories" ? active : inactive}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
              strokeWidth="1.5"
              stroke="currentColor"
              className={path === "/categories" ? iconActive : iconInactive}
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
            ...
            <div className={path === "/categories" ? "round" : ""}></div>
            Categories
          </div>
        </Link>
        <Link href={"/orders"}>
          <div className={path === "/orders" ? active : inactive}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
              strokeWidth="1.5"
              stroke="currentColor"
              className={path === "/orders" ? iconActive : iconInactive}
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
            ...
            <div className={path === "/orders" ? "round" : ""}></div>
            Orders
          </div>
        </Link>
        <Link href={"/settings"}>
          <div className={path === "/settings" ? active : inactive}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
              strokeWidth="1.5"
              stroke="currentColor"
              className={path === "/settings" ? iconActive : iconInactive}
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
            ...
            <div className={path === "/settings" ? "round" : ""}></div>
            Settings
          </div>
        </Link>
